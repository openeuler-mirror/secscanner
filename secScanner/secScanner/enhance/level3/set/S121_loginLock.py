...
deny_times = seconf.get('level3', 'deny_times')
unlock_time = seconf.get('level3', 'unlock_time')
lock_attacking_user = seconf.get('level3', 'lock_attacking_user')
...
def S121_loginLock():
    ...
    if OS_ID.lower() in ['bclinux', 'openeuler']:
        if OS_DISTRO in ['7']:
            el7_set_deny()
        elif OS_DISTRO in ['21.10', '22.10', '8', '22.10U1', '22.10U2', 'v24', '24', '21.10U4', '21.10 U4', 'V25']:
            set_deny()
        else:
