...
def S427_dovecotDisabled():
    InsertSection("set IMAP POP3 service disabled")
    SET_DOVECOT = seconf.get('level3', 'set_dovecot')
    if SET_DOVECOT == 'yes':
        # check status of dovecot
        ...
        Display("- Skip set dovecot service due to config file...", "SKIPPING")
