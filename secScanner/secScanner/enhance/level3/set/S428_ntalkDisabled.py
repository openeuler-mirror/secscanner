...
def S428_ntalkDisabled():
    InsertSection("set ntalk service disabled")
    SET_NTALK = seconf.get('level3', 'set_ntalk')
    if SET_NTALK == 'yes':
        # check status of ntalk
        service_name = "ntalk"
        ...
        Display("- Skip set ntalk service due to config file...", "SKIPPING")
