    ...
    if os.path.exists('/etc/shadow'):
        ...
        if expired_accounts:
            with open(RESULT_FILE, "a") as file:
                file.write("\nC231\n")
            logger.warning("WRN_C231_01: %s", WRN_C231_01)
            logger.warning("SUG_C231_01: %s", SUG_C231_01)
        ...
        with open(RESULT_FILE, "a") as file:
            file.write("\nC231\n")
        logger.warning("WRN_C231_02: %s", WRN_C231_02)
        logger.warning("SUG_C231_02: %s", SUG_C231_02)
