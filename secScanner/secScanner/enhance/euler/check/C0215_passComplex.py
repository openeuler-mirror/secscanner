...
def C0215_passComplex():
    ...
    if not t_minlen.strip().isdigit():
        ...
        with open(RESULT_FILE, "a") as file:
            file.write("\nC0215\n")
        logger.warning("WRN_C0215_02: %s", WRN_C0215_02)
        logger.warning("SUG_C0215_01: %s", SUG_C0215_01)
        Display("- No Password Minlen set...", "WARNING")
    elif int(t_minlen) < 10:  # '' < '7' but '' cant enter here
        with open(RESULT_FILE, "a") as file:
            file.write("\nC0215\n")
        logger.warning("WRN_C0215_01: %s", WRN_C0215_01)
        logger.warning("SUG_C0215_01: %s", SUG_C0215_01)
    ...
    if t_minclass == '':
        with open(RESULT_FILE, "a") as file:
            file.write("\nC0215\n")
        logger.warning("WRN_C0215_04: %s", WRN_C0215_04)
        logger.warning("SUG_C0215_02: %s", SUG_C0215_02)
        Display("- No Password Minclass set...", "WARNING")
    elif int(t_minclass) < 4:  # should >= 4
        with open(RESULT_FILE, "a") as file:
            file.write("\nC0215\n")
        logger.warning("WRN_C0215_03: %s", WRN_C0215_03)
        logger.warning("SUG_C0215_02: %s", SUG_C0215_02)
    ...
    if n_ucredit == '':
        with open(RESULT_FILE, "a") as file:
            file.write("\nC0215\n")
        logger.warning("WRN_C0215_06: %s", WRN_C0215_06)
        logger.warning("SUG_C0215_03: %s", SUG_C0215_03)
        Display("- No Password ucredit set...", "WARNING")
    elif n_ucredit > '-1':  # '' < '7' but '' cant enter here
        with open(RESULT_FILE, "a") as file:
            file.write("\nC0215\n")
        logger.warning("WRN_C0215_05: %s", WRN_C0215_05)
        logger.warning("SUG_C0215_03: %s", SUG_C0215_03)
    ...
    if n_lcredit == '':
        with open(RESULT_FILE, "a") as file:
            file.write("\nC0215\n")
        logger.warning("WRN_C0215_08: %s", WRN_C0215_08)
        logger.warning("SUG_C0215_04: %s", SUG_C0215_04)
        Display("- No Password lcredit set...", "WARNING")
    elif n_lcredit > '-1':  # '' < '7' but '' cant enter here
        with open(RESULT_FILE, "a") as file:
            file.write("\nC0215\n")
        logger.warning("WRN_C0215_07: %s", WRN_C0215_07)
        logger.warning("SUG_C0215_04: %s", SUG_C0215_04)
    ...
    if n_dcredit == '':
        with open(RESULT_FILE, "a") as file:
            file.write("\nC0215\n")
        logger.warning("WRN_C0215_10: %s", WRN_C0215_10)
        logger.warning("SUG_C0215_05: %s", SUG_C0215_05)
        Display("- No Password dcredit set...", "WARNING")
    elif n_dcredit > '-1':  # '' < '7' but '' cant enter here
        with open(RESULT_FILE, "a") as file:
            file.write("\nC0215\n")
        logger.warning("WRN_C0215_09: %s", WRN_C0215_09)
        logger.warning("SUG_C0215_05: %s", SUG_C0215_05)
    ...
    if n_ocredit == '':
        with open(RESULT_FILE, "a") as file:
            file.write("\nC0215\n")
        logger.warning("WRN_C0215_12: %s", WRN_C0215_12)
        logger.warning("SUG_C0215_06: %s", SUG_C0215_06)
        Display("- No Password ocredit set...", "WARNING")
    elif n_ocredit > '-1':  # '' < '7' but '' cant enter here
        with open(RESULT_FILE, "a") as file:
            file.write("\nC0215\n")
        logger.warning("WRN_C0215_11: %s", WRN_C0215_11)
        logger.warning("SUG_C0215_06: %s", SUG_C0215_06)
    ...
    if enforce_root == 'unset':
        with open(RESULT_FILE, "a") as file:
            file.write("\nC0215\n")
        logger.warning("WRN_C0215_13: %s", WRN_C0215_13)
        logger.warning("SUG_C0215_07: %s", SUG_C0215_07)
