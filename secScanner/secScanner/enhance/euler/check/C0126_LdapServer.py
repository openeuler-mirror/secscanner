...
def C0126_LdapServer():
    ...
    if ret == 0:
        ...
        Display(f"- Check the openldap-servers software is installed...", "WARNING")
    else:
        logger.info(f"The openldap-servers status is: {res}")
        Display(f"- Check the openldap-servers software is uninstall...", "OK")
