...
def S0221_loginDefs():
    ...
    SET_PASS_MAX_DAYS = seconf.get('euler', 'set_pass_max_days')
    PASS_MAX_DAYS_VALUE = seconf.get('euler', 'pass_max_days_value')
    SET_PASS_MIN_DAYS = seconf.get('euler', 'set_pass_min_days')
    PASS_MIN_DAYS_VALUE = seconf.get('euler', 'pass_min_days_value')
    SET_PASS_MIN_LEN = seconf.get('euler', 'set_pass_min_len')
    PASS_MIN_LEN_VALUE = seconf.get('euler', 'pass_min_len_value')
    SET_PASS_WARN_AGE = seconf.get('euler', 'set_pass_warn_age')
    PASS_WARN_AGE_VALUE = seconf.get('euler', 'pass_warn_age_value')
