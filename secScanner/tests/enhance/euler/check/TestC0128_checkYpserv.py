...
from secScanner.enhance.euler.check.C0128_checkYpserv import C0128_checkYpserv

class TestC0128_checkYpserv(unittest.TestCase):
    ...
    def test_LdapServer_installed(self, mock_file, mock_display, mock_logger, mock_getstatusoutput, mock_InsertSection, mock_getsize, mock_exists):
        ...
        mock_InsertSection.assert_called_once_with("Check whether the ypserv software is installed in your Linux System ")
        mock_logger.info.assert_called_once_with('The ypserv status is: uninstalled')
        mock_display.assert_called_with("- Check the ypserv software is uninstall...", "OK")
    ...
    def test_LdapServer_uninstalled(self, mock_file, mock_display, mock_logger, mock_getstatusoutput, mock_InsertSection, mock_getsize, mock_exists):
        ...
        # Mock test setup.
        secScanner.enhance.euler.check.C0128_checkYpserv.RESULT_FILE = "result_file_path"  # Mock test setup.
        # Mock test setup.
        ...
        C0128_checkYpserv()
        mock_InsertSection.assert_called_once_with("Check whether the ypserv software is installed in your Linux System ")
        mock_logger.warning.assert_any_call("WRN_C0128: %s", WRN_C0128)
        mock_logger.warning.assert_any_call("SUG_C0128: %s", SUG_C0128)
        mock_display.assert_called_with("- Check the ypserv software is installed...", "WARNING")        
    ...
    def test_011_ret0_display_warning_exact(self, mock_file, mock_display, mock_logger, mock_getstatusoutput, mock_InsertSection, mock_getsize, mock_exists):
        ...
        C0128_checkYpserv()
        args, _ = mock_display.call_args
        self.assertEqual(args[0], "- Check the ypserv software is installed...")
