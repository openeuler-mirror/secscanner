...
class TestC0221_loginDefs(unittest.TestCase):
    @patch('secScanner.enhance.euler.check.C0221_loginDefs.InsertSection')
    @patch('secScanner.enhance.euler.check.C0221_loginDefs.open', new_callable=mock_open, read_data="PASS_MAX_DAYS 90\nPASS_MIN_DAYS 5\nPASS_MIN_LEN 8\nPASS_WARN_AGE 30\n")
    ...
    @patch('secScanner.enhance.euler.check.C0221_loginDefs.InsertSection')
    @patch('secScanner.enhance.euler.check.C0221_loginDefs.open', new_callable=mock_open, read_data="PASS_MAX_DAYS 98\nPASS_MIN_DAYS 3\nPASS_MIN_LEN 6\nPASS_WARN_AGE 20\n")
    @patch('secScanner.enhance.euler.check.C0221_loginDefs.logger')
    @patch('secScanner.enhance.euler.check.C0221_loginDefs.Display')
    #@patch('secScanner.enhance.euler.check.C0221_loginDefs.InsertSection')
