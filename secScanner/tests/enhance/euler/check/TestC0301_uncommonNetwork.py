...
class TestC0301_uncommonNetwork(unittest.TestCase):
    ...
    def test_sctp_and_tipc_enabled(self, mock_getstatusoutput, mock_open, mock_display, mock_logger, mock_InsertSection):
        ...
        mock_logger.warning.assert_any_call("SUG_C0301_01: %s", SUG_C0301_01)
        mock_display.assert_any_call("- Check sctp and tipc should be avoided...", "WARNING")
        mock_open.assert_any_call("result_file_path", "a")
    ...
    def test_sctp_chech_error(self, mock_getstatusoutput, mock_open, mock_display, mock_logger, mock_InsertSection):
        ...
        C0301_uncommonNetwork()
        mock_InsertSection.assert_any_call("Check avoid using uncommon network service")
        mock_logger.warning.assert_any_call("A error occurred while checking sctp")
        mock_display.assert_any_call("- A error occurred while checking sctp...", "WARNING")
    ...
    def test_tipc_chech_error(self, mock_getstatusoutput, mock_open, mock_display, mock_logger, mock_InsertSection):
        ...
        C0301_uncommonNetwork()
        mock_InsertSection.assert_any_call("Check avoid using uncommon network service")
        mock_logger.warning.assert_any_call("A error occurred while checking tipc")
        mock_display.assert_any_call("- A error occurred while checking tipc...", "WARNING")
