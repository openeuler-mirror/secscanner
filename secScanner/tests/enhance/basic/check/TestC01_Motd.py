...
from secScanner.enhance.basic.check.C01_motd import C01_motd  # Mock test setup.
...
class TestC01_Motd(unittest.TestCase):
    ...
    def test_motd_not_exists_or_empty(self, mock_file, mock_InsertSection, mock_Display, mock_logger, mock_getsize, mock_exists):
        ...
        # Mock test setup.
        secScanner.enhance.basic.check.C01_motd.RESULT_FILE = "result_file_path"  # Mock test setup.
